...
{
    public class SampleBehaviours : BehaviourDefinition<ushort, SampleEntity, SampleWorld>
    {
        public override void Build(BehaviourBuilder<ushort, SampleEntity, SampleWorld> builder)
        {
            ...
            builder.Init(SampleTypes.EnemyArcher
                ...
                State("move",
                    ...
                    Delay(2000, // after 2 seconds
                        If((ref SampleEntity x, ref SampleWorld y) => x.HasTargetableWithin(15), SetState("shoot")) // if a player is within 15 units, goto shoot state
                    )
                ),
                State("shoot",
